...
| [Astro](https://astro.build/)         | 🟡     |                                                                           |
| [Nuxt3](https://nuxt.com/)            | 🟡     |                                                                           |
| [Farm](https://www.farmfe.org/)       | 🔴     | Tested & model files are not emitted (see #27). Contributions welcome! ❤️ |
| [Webpack](https://webpack.js.org/)    | 🔴     | Tested & model files are borked (see #30). Contributions welcome! ❤️      |
